...
__all__ = ('ReplyParameters', 'ChatAdministratorRights', 'TextQuote', 'PassportElementErrorFrontSide', 'ChatBoostAdded', 'MaybeInaccessibleMessage', 'InputMediaVoiceNote', 'RichTextCustomEmoji', 'MessageEntity', 'RichBlockCollage', 'InlineQueryResultCachedPhoto', 'InputMediaVideo', 'ReactionType', 'InlineQueryResultCachedDocument', 'ChecklistTasksAdded', 'PaidMessagePriceChanged', 'ChatBoostSourceGiveaway', 'TransactionPartner', 'ChatMemberRestricted', 'ReplyKeyboardRemove', 'MenuButtonCommands', 'BotCommandScopeChatMember', 'RichBlockMap', 'ManagedBotCreated', 'ChecklistTasksDone', 'PassportElementErrorFiles', 'BotCommandScopeChatAdministrators', 'RichTextCode', 'TransactionPartnerTelegramApi', 'InlineQueryResultCachedGif', 'ChatBoostSource', 'BotSubscriptionUpdated', 'InputMediaPhoto', 'RichTextUnderline', 'BotCommand', 'SuggestedPostPrice', 'DirectMessagesTopic', 'ChatMemberUpdated', 'InputRichMessageMedia', 'InputMediaLink', 'Contact', 'ChatBackground', 'OwnedGiftRegular', 'VideoChatEnded', 'InputMediaAnimation', 'BotCommandScopeAllPrivateChats', 'UniqueGiftSymbol', 'SuccessfulPayment', 'PassportElementErrorUnspecified', 'InlineQueryResultVideo', 'WebAppInfo', 'ShippingOption', 'CallbackQuery', 'MessageOriginChannel', 'RichBlockVoiceNote', 'RichBlockParagraph', 'ChatInviteLink', 'InputRichBlockExpandableBlockQuotation', 'InputPaidMedia', 'InputMediaVenue', 'ChosenInlineResult', 'InputRichBlockParagraph', 'InputProfilePhotoStatic', 'RichBlockFooter', 'InlineQueryResultContact', 'UserProfileAudios', 'WriteAccessAllowed', 'InlineQueryResultPhoto', 'Birthdate', 'RichBlockAnchor', 'StarAmount', 'PassportData', 'OrderInfo', 'ChatShared', 'UniqueGiftColors', 'VideoChatStarted', 'Link', 'InputContactMessageContent', 'StoryAreaTypeLink', 'AffiliateInfo', 'PaidMediaPhoto', 'InputMediaSticker', 'BotCommandScopeAllGroupChats', 'TransactionPartnerUser', 'StoryAreaPosition', 'RichMessageButton', 'InputStoryContentPhoto', 'ChatBoost', 'GeneralForumTopicUnhidden', 'SwitchInlineQueryChosenChat', 'Chat', 'PollOptionDeleted', 'BackgroundFillSolid', 'CallbackGame', 'PassportElementErrorDataField', 'Dice', 'BackgroundTypeChatTheme', 'InputProfilePhoto', 'TransactionPartnerChat', 'ChatPermissions', 'CommunityChatJoined', 'LinkPreviewOptions', 'MessageReactionUpdated', 'InputPaidMediaPhoto', 'InputRichBlockList', 'InputVenueMessageContent', 'PaidMedia', 'InlineQueryResultsButton', 'GeneralForumTopicHidden', 'InputRichBlockTable', 'BackgroundTypeFill', 'BusinessConnection', 'BackgroundFillGradient', 'InputMediaAudio', 'RichBlockBlockQuotation', 'LivePhoto', 'BusinessLocation', 'DirectMessagePriceChanged', 'Story', 'UserChatBoosts', 'InputInvoiceMessageContent', 'RichTextBold', 'PassportElementError', 'InlineQueryResultArticle', 'RichTextMathematicalExpression', 'AcceptedGiftTypes', 'RichBlockPreformatted', 'BusinessMessagesDeleted', 'UniqueGiftBackdrop', 'BusinessBotRights', 'RichBlockAnimation', 'GiveawayCreated', 'InlineQueryResultCachedVideo', 'WebhookInfo', 'ResponseParameters', 'User', 'PreCheckoutQuery', 'KeyboardButtonRequestUsers', 'InputMediaDocument', 'ChecklistTask', 'InputRichMessage', 'RichTextMarked', 'InputMessageContent', 'Model', 'SuggestedPostPaid', 'BotDescription', 'InputPaidMediaLivePhoto', 'RichTextSuperscript', 'ExternalReplyInfo', 'KeyboardButtonPollType', 'RichBlockTable', 'StarTransactions', 'PollMedia', 'StickerSet', 'PollAnswer', 'BusinessOpeningHoursInterval', 'ReplyKeyboardMarkup', 'RichTextUrl', 'MenuButtonWebApp', 'KeyboardButtonRequestManagedBot', 'Audio', 'SuggestedPostParameters', 'Venue', 'InputFile', 'PollOption', 'RevenueWithdrawalStateFailed', 'RichText', 'InputRichBlockMap', 'BotName', 'EncryptedCredentials', 'ProximityAlertTriggered', 'PreparedKeyboardButton', 'ChatMember', 'BotCommandScopeChat', 'RichTextReferenceLink', 'UniqueGiftModel', 'RichBlockDivider', 'PassportElementErrorTranslationFile', 'UniqueGift', 'ChatLocation', 'ChatBoostRemoved', 'Video', 'InputPollMedia', 'BackgroundType', 'File', 'RichBlockPullQuotation', 'InlineQueryResult', 'InputMediaLocation', 'StoryAreaTypeWeather', 'ShippingAddress', 'TransactionPartnerFragment', 'BackgroundFill', 'MessageOriginUser', 'InlineQueryResultCachedAudio', 'PassportElementErrorReverseSide', 'ChatMemberOwner', 'SuggestedPostApprovalFailed', 'InputRichBlock', 'RichBlockSlideshow', 'TransactionPartnerOther', 'MessageReactionCountUpdated', 'GiveawayCompleted', 'RichTextAnchorLink', 'RichTextSpoiler', 'InlineKeyboardMarkup', 'SuggestedPostRefunded', 'PaidMediaPreview', 'Checklist', 'SentGuestMessage', 'InlineQueryResultLocation', 'Gifts', 'MessageId', 'InputRichBlockButtons', 'RichBlockDetails', 'PassportElementErrorFile', 'InputRichBlockBlockQuotation', 'SuggestedPostApproved', 'RichBlockTableCell', 'PollOptionAdded', 'InputRichBlockVoiceNote', 'KeyboardButtonRequestChat', 'RichTextSubscript', 'BackgroundTypePattern', 'OwnedGiftUnique', 'GameHighScore', 'KeyboardButton', 'Animation', 'LabeledPrice', 'SharedUser', 'GiftBackground', 'StoryArea', 'OwnedGift', 'InputRichBlockAnimation', 'SentWebAppMessage', 'MaskPosition', 'InputRichBlockAnchor', 'RichTextReference', 'InputRichBlockFooter', 'VideoQuality', 'InputRichBlockMathematicalExpression', 'CopyTextButton', 'Poll', 'GiftInfo', 'MessageGenerationStopped', 'RichTextTextMention', 'RichBlockDocument', 'UniqueGiftInfo', 'UserProfilePhotos', 'StoryAreaTypeUniqueGift', 'RichTextBankCardNumber', 'InlineQueryResultCachedMpeg4Gif', 'RichBlockListItem', 'InputRichBlockDetails', 'RichTextMention', 'MessageOrigin', 'InputRichBlockDocument', 'RefundedPayment', 'ReactionCount', 'InputSticker', 'PhotoSize', 'ReactionTypeEmoji', 'BusinessIntro', 'Invoice', 'StarTransaction', 'RichBlockMathematicalExpression', 'ForumTopicCreated', 'InputRichBlockVideo', 'InlineQueryResultMpeg4Gif', 'LocationAddress', 'RichTextButton', 'InputRichBlockDivider', 'RichTextItalic', 'InlineQuery', 'ChatBoostUpdated', 'ChatBoostSourceGiftCode', 'ForceReply', 'PaidMediaLivePhoto', 'RichBlockList', 'PassportElementErrorSelfie', 'ChatOwnerChanged', 'InlineQueryResultVenue', 'ShippingQuery', 'InputRichMessageContent', 'BackgroundTypeWallpaper', 'Voice', 'InputTextMessageContent', 'ChatMemberAdministrator', 'SuggestedPostInfo', 'PassportElementErrorTranslationFiles', 'InputRichBlockThinking', 'ManagedBotUpdated', 'InputLocationMessageContent', 'Location', 'RichMessage', 'RichBlockPhoto', 'RichBlockSectionHeading', 'InlineQueryResultVoice', 'Giveaway', 'TransactionPartnerTelegramAds', 'RichTextDateTime', 'Message', 'MenuButtonDefault', 'PreparedInlineMessage', 'BotCommandScope', 'Update', 'InputRichBlockListItem', 'ChatFullInfo', 'InputRichBlockAudio', 'SuggestedPostDeclined', 'RichTextBotCommand', 'ForumTopicReopened', 'InputPollOption', 'RichTextHashtag', 'InlineQueryResultDocument', 'UniqueGiftBackdropColors', 'BotShortDescription', 'UsersShared', 'ChatMemberLeft', 'InlineQueryResultAudio', 'InputMediaLivePhoto', 'LoginUrl', 'VideoNote', 'BotAccessSettings', 'ChatBoostSourcePremium', 'ForumTopicClosed', 'VideoChatParticipantsInvited', 'Document', 'GiveawayWinners', 'Gift', 'MessageOriginChat', 'MessageAutoDeleteTimerChanged', 'UserRating', 'InputRichBlockPreformatted', 'ForumTopicEdited', 'PaidMediaPurchased', 'RevenueWithdrawalStatePending', 'InlineQueryResultGame', 'InputStoryContentVideo', 'MenuButton', 'InaccessibleMessage', 'StoryAreaTypeSuggestedReaction', 'RichBlockAudio', 'InputMedia', 'PassportFile', 'CommunityChatAdded', 'StoryAreaTypeLocation', 'InlineQueryResultCachedVoice', 'PaidMediaVideo', 'RichTextCashtag', 'MessageOriginHiddenUser', 'InputChecklistTask', 'RevenueWithdrawalStateSucceeded', 'WebAppData', 'CommunityChatRemoved', 'RichTextPhoneNumber', 'RichBlockThinking', 'RichBlockCaption', 'RichTextEmailAddress', 'ReactionTypePaid', 'InputPollOptionMedia', 'Sticker', 'VideoChatScheduled', 'EphemeralMessageParameters', 'InputProfilePhotoAnimated', 'ChatJoinRequest', 'StoryAreaType', 'TransactionPartnerAffiliateProgram', 'BackgroundFillFreeformGradient', 'InlineQueryResultCachedSticker', 'RichBlockButtons', 'BusinessOpeningHours', 'InputRichBlockCollage', 'RevenueWithdrawalState', 'RichBlockExpandableBlockQuotation', 'ChatMemberMember', 'RichBlockVideo', 'OwnedGifts', 'ChatOwnerLeft', 'InputRichBlockSectionHeading', 'InputStoryContent', 'ChatPhoto', 'ReactionTypeCustomEmoji', 'BotCommandScopeAllChatAdministrators', 'ChatMemberBanned', 'EncryptedPassportElement', 'InputRichBlockPullQuotation', 'InputPaidMediaVideo', 'InputRichBlockPhoto', 'RichTextStrikethrough', 'Game', 'InputChecklist', 'ForumTopic', 'PaidMediaInfo', 'DisabledButton', 'RichTextAnchor', 'InputRichBlockSlideshow', 'InlineQueryResultGif', 'RichBlock', 'InlineKeyboardButton', 'Community', 'BotCommandScopeDefault')
